...
export interface HelloWorldInterface extends Interface {
  getFunction(
    nameOrSignature: "changeGreeting" | "greeting" | "hello"
  ): FunctionFragment;
...
export interface HelloWorld extends BaseContract {
  ...
  changeGreeting: TypedContractMethod<
    [newGreeting: string],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "changeGreeting"
  ): TypedContractMethod<[newGreeting: string], [void], "nonpayable">;
  getFunction(
